...
const ZH = process.env.ZH_ROOT || 'K:/Projects/website/raspd/zh/social_democracy_redux_zh/source/scenes';
const EN = process.env.EN_ROOT || 'K:/Projects/website/raspd/origin/social_democracy_redux/source/scenes';
